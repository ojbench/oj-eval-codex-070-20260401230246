...
class ACMOJClient:
    ...
    def submit_code(self, problem_id: int, code: str, language: str = "git") -> Optional[Dict]:
        """Submit raw code content to the OJ. Default language kept as 'git' for compatibility."""
...
def main():
    ...
    # Submit local file content (e.g., src.hpp) as code
    ...
    submit_file_parser.add_argument("--language", type=str, default="git", help="Language tag (default: git)")
